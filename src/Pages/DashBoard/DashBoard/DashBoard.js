    ...
    return (
        ...
        <div class="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80">
            <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                ...
                <nav class="mt-6">
                    <div>
                        <Link class="w-full font-thin uppercase text-pink-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-pink-100 border-r-4 border-pink-500 dark:from-gray-700 dark:to-gray-800 border-r-4 border-pink-500" to="/dashboard">
                        ...
                        <Link class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-pink-500" to="/">
                            <span class="text-left">
