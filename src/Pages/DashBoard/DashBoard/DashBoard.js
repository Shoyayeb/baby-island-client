        ...
        <div>
            <div className=" bg-white lg:my-10">
                <nav className=" flex items-center justify-center gap-10 mx-40" aria-label="Global">
                    <button
                        onClick={myOrders}
                        className="md:px-5 md:py-5 px-3 py-1 transition ease-in duration-200 uppercase  rounded md:rounded-full hover:bg-pink-500 hover:text-white border-2 border-pink-600 focus:outline-none flex flex-col justify-center items-center">
