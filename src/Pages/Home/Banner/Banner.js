...
const Banner = () => {
    return (
        <div class="bg-white dark:bg-gray-800 lg:flex lg:items-center">
            <div class="w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
                <h2 class="text-4xl font font-extrabold tracking-tight text-gray-900 hover:text-pink-500 sm:text-6xl">
                    <span class="block">
                ...
                <div class="lg:mt-0 lg:flex-shrink-0">
                    <div class="mt-12 inline-flex rounded-md shadow">
                        <Link to="/explore" class="py-4 px-9  bg-pink-600 hover:bg-pink-700 focus:ring-pink-500 focus:ring-offset-pink-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                            Explore
                        </Link>
                    </div>
                </div>
            ...
            <div class="flex items-center gap-8 p-8 lg:p-24">
                <img src="https://image.freepik.com/free-photo/two-little-baby-girls-playing-with-toys-inflatable-pool-summer-sunny-day_155003-16124.jpg" class="rounded-lg w-1/2" alt="Tree" />
                <div>
                    <img src="https://image.freepik.com/free-photo/two-year-kid-bathes-with-toys_1398-669.jpg" class="rounded-lg mb-8" alt="Tree" />
                    <img src="https://image.freepik.com/free-photo/little-toddler-boy-bathing-park_1303-15972.jpg" class="rounded-lg" alt="Tree" />
                </div>
            </div>
        </div>
